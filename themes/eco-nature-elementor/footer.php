...
<footer class="footer-side">
  <?php if( get_theme_mod( 'eco_nature_elementor_show_footer_widget',true)) : ?>
  ...
  <?php endif; ?>  
  <?php if( get_theme_mod( 'eco_nature_elementor_show_footer_copyright',true)) : ?>
    <div class="footer-copyright">
      <div class="container">
            ...
            <p class="mb-0 py-3 text-center text-md-start">
              <?php
                if (!get_theme_mod('eco_nature_elementor_footer_text') ) { ?>
                  <a href="<?php echo esc_url(__('https://www.wpelemento.com/products/free-nature-wordpress-theme', 'eco-nature-elementor' )); ?>" target="_blank">
        ...
        <?php if(get_theme_mod('eco_nature_elementor_footer_social_icon_hide', false )== true){ ?>
          <div class="row">
            <div class="col-12 align-self-center py-1">
              <div class="footer-links">
                <?php $eco_nature_elementor_settings_footer = get_theme_mod( 'eco_nature_elementor_social_links_settings_footer' ); ?>
                <?php if ( is_array($eco_nature_elementor_settings_footer) || is_object($eco_nature_elementor_settings_footer) ){ ?>
                  <?php foreach( $eco_nature_elementor_settings_footer as $eco_nature_elementor_setting_footer ) { ?>
                    <a href="<?php echo esc_url( $eco_nature_elementor_setting_footer['link_url'] ); ?>" target="_blank">
                      <i class="<?php echo esc_attr( $eco_nature_elementor_setting_footer['link_text'] ); ?> me-2"></i>
                    </a>
                  <?php } ?>
                <?php } ?>
              </div>
  ...
  <?php endif; ?>
  <?php if(get_theme_mod('eco_nature_elementor_progress_bar', false )== true): ?>
    <div id="elemento-progress-bar" class="theme-progress-bar top"></div>
  <?php endif; ?>
  <?php if(get_theme_mod('eco_nature_elementor_cursor_outline', false )== true): ?>
			<!-- Custom cursor -->
