		...
		$manager->add_section(
			new Eco_Nature_Elementor_Customize_Section_Pro(
				...
				array(
					...
					'pro_text'    => esc_html__( 'GET PRO', 'eco-nature-elementor' ),
					'pro_url'     => 'https://www.wpelemento.com/products/eco-nature-wordpress-theme',
					'priority'    => 5,
				)
			)
		);
		...
		$manager->add_section(
			new Eco_Nature_Elementor_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://preview.wpelemento.com/theme-documentation/eco-nature-elementor/',
					'priority'    => 5,
				)
			)
		);
		...
		$manager->add_section(
			new Eco_Nature_Elementor_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://preview.wpelemento.com/eco-nature-elementor/',
					'priority'    => 5,
				)
			)
		);
